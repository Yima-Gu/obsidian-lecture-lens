export const en = {
	...
	"chat.contextPanel.historyOmittedBudget": "{{count}} earlier turn(s) omitted to fit budget",
	"chat.contextPanel.historyOmittedTurnLimit": "{{count}} turn(s) omitted by turn limit",
	"chat.contextPanel.budgetOver": "Over context budget — content was trimmed",
	"chat.contextPanel.budgetTight": "Near context budget limit",
	...
	"chat.contextPanel.ragBudgetDropped": "{{count}} RAG chunk(s) omitted to fit budget",
	"chat.contextPanel.ragBudgetTruncated": "Last RAG excerpt truncated to fit budget",
	...
	"chat.contextSegment.user": "Current message",
